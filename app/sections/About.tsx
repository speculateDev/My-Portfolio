...
function About() {
  return (
    <section id="about" className="py-28 md:py-32 lg:py-40 relative">
      <div className="lg-container">
        <p className="section-subtitle">About Me</p>
        <h2 className="section-title">Get to Know Me</h2>

        <div className="w-full grid grid-cols-6 gap-8 mt-25">
          {/* Hobbies Card */}
          <div className="card col-span-2 h-90">
            ...
            <div className="relative aspect-square rounded-xl mt-10">
              <Image
                alt="Carl Jung"
                src={JungImg}
                fill
          ...
          {/* Map Card */}
          <div className="col-start-2 col-span-3 card h-80 relative">
